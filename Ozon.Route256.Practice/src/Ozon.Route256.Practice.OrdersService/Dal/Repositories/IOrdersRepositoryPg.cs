...
public interface IOrdersRepositoryPg
{
    ...
    Task<List<(OrderDal order, AddressDal address, RegionDal region)>> GetAllAsync(OrderFilterOptionsShard filterOptions, CancellationToken token, bool internalRequest = false);
